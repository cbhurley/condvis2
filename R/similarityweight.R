...
#'   \code{"maxnorm"} and \code{"manhattan"}
...
similarityweight <-
function (x, data, threshold = NULL, distance = "euclidean", lambda = NULL, scale=TRUE)
{
  ## Initialise the internal function

  vwfun <- .similarityweight(xc = data, scale=scale)
