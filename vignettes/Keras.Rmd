...
dtf <- data.frame(cbind(Pima.training,  Pima.trainLabels))
dtf$Pima.trainLabels <- as.factor(dtf$Pima.trainLabels)

dtf.te <- data.frame(cbind(Pima.testing,  Pima.testLabels))
dtf.te$Pima.testLabels <- as.factor(dtf.te$Pima.testLabels)
